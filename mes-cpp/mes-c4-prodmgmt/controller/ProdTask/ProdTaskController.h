...
public:
	...
	// 3.2 定义修改接口处理
	API_HANDLER_ENDPOINT_AUTH(API_M_PUT, "/ProdTask", modifyProdTask, BODY_DTO(ProdTaskModifyDTO::Wrapper, dto), execModifyProdTask(dto));
	...
	// 3.2 定义删除接口处理
	API_HANDLER_ENDPOINT_AUTH(API_M_DEL, "/ProdTask/{id}", removeProdTask, PATH(UInt64, id), execRemoveProdTask(id));
