...
ProdOrderPageJsonVO::Wrapper ProdOrderController::execQuerySample(const ProdOrderQuery::Wrapper& query, const PayloadDTO& payload)
{
	return {}
}
...
Uint64JsonVO::Wrapper ProdOrderController::execModifySample(const ProdOrderDTO::Wrapper& dto)
{
	return {}
}
