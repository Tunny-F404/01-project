...
*/
#ifndef _AddPRODUCEWORKDO_H_
#define _AddPRODUCEWORKDO_H_

#include "../DoInclude.h"
/**
 * 测试菜单数据库实体
 */
class addProduceWorkDo
{	// 报工类型
...
public:
	addProduceWorkDo() {}
	addProduceWorkDo(string feedback_type, string feedback_code,
		...
		string quantity_uncheck, string record_nick,
