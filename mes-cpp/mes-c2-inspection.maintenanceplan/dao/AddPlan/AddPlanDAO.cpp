...
{
	string sql = "INSERT INTO `dv_check_plan` (`plan_code`,`plan_name`, `plan_type`, `cycle_count`, `cycle_type`, `start_date`, `end_date`, `status`, `remark`,`create_by`, `create_time`) VALUES (?,?,?, ?, ?, ?, ?, ?, ?, ?, ?)";//加了
