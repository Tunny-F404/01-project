...
public:
	...
	API_HANDLER_ENDPOINT_AUTH(API_M_POST, "/device-list/add-device", addProj, BODY_DTO(AddDeviceDTO::Wrapper, dto), execAddProj(dto));



private:

	Uint64JsonVO::Wrapper execAddProj(const AddDeviceDTO::Wrapper& dto);
