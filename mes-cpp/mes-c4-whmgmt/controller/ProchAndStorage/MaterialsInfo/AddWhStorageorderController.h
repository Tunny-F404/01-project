...
public:
	...
	//3.2 定义新增接口处理
	ENDPOINT(API_M_POST, "/prochandstorage/materialsinfo/add-wh-storage-order", addWhStorageorder, BODY_DTO(AddWhStorageorderDTO::Wrapper, dto), API_HANDLER_AUTH_PARAME) {
		//呼叫执行函数响应结果
