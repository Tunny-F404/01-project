...
public: // 定义接口
	...
	ENDPOINT_INFO(queryReceipt) {
		...
		API_DEF_ADD_QUERY_PARAMS(String, "recptName", ZH_WORDS_GETTER("receipt.query.fields.recptName"), "采购入库检验测试", false);
		API_DEF_ADD_QUERY_PARAMS(String, "vendorName", ZH_WORDS_GETTER("receipt.query.fields.vendorName"), "江苏南通塑有为塑料制品有限公司", false);
