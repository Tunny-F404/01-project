...
public:
	...
	// 3.2 定义修改接口处理
	API_HANDLER_ENDPOINT_AUTH(API_M_PUT, "/equipment-ledger/equipmentmanagement", modifyEquipmentType, BODY_DTO(ModifyEquipmentTypeDTO::Wrapper, dto), execModifyEquipmentType(dto));
