      ...
      <el-main>
        <el-row :gutter="20" class="input-row">
          <el-col :span="6">
            ...
            <el-input v-model="workstationCode" placeholder="请输入工作站编码" />
          </el-col>
          <el-col :span="6">
            <span class="input-label">工作站名称：</span>
            <el-input v-model="workstationName" placeholder="请输入工作站名称" />
          </el-col>
          <el-col :span="6">
            <span class="input-label">车间名称：</span>
            <el-select v-model="selectedWorkshop" placeholder="请选择车间">
          ...
          <el-col :span="6">
            ...
            <el-select v-model="selectedOrder" placeholder="请选择工序">
        ...
        <el-row :gutter="20" class="action-row">
          <el-col :span="6">
            <el-button @click="handleHumanResource" class="action-button">人力资源</el-button>
          </el-col>
          <el-col :span="6">
            <el-button @click="handleEquipment" class="action-button">设备资源</el-button>
          </el-col>
          <el-col :span="6">
            <el-button @click="handleTools" class="action-button">工装夹具</el-button>
          </el-col>
