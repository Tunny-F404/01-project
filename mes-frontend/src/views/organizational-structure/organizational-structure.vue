<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <!-- right-toolbar component will be placed here -->
        </el-row>

        <el-table v-loading="loading" :data="deptList" row-key="deptId" :default-expand-all="isExpandAll"
            ...
            <el-table-column label="创建时间" align="center" prop="createTime" width="200">
                <!-- Custom template for creation time column -->
            </el-table-column>
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="上级部门">
                            <!-- treeselect component will be placed here -->
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
