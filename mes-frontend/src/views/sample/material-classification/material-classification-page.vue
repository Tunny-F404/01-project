<template>
	<div class="material-classification">
		<template class="search-bar">
			...
			<el-button size="medium" type="primary" @click="search" :icon="Search"
				>搜索</el-button
			>
		...
		>
			...
			<el-table-column prop="isLaunched" label="是否启用">
				<template #default="scope">
					<el-tag
						:type="scope.row.isLaunched ? 'success' : 'warning'"
						disable-transitions
						>{{ scope.row.isLaunched ? '是' : '否' }}</el-tag
					>
				</template>
			</el-table-column>
