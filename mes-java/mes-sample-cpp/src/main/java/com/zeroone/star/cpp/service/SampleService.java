...
import com.zeroone.star.cpp.factory.CppServiceFallBack;
...
public interface SampleService {
    @GetMapping("/sample")
    JsonVO<PageDTO<SampleDTO>> get(@RequestParam Map<String, Object> params);
    ...
    JsonVO<Long> delete(@PathVariable Integer id);
}
